            ...
            <div className="whyuseusContent">
                <div className="whyuseusRow">
                    <div className="whyuseusGrid">
                        <img src="https://spaceboat.in/static/img/spacepartner/SP_Safe_Secure.png"  alt=":-)"/>
                        <h3>SAFETY AND SECURITY</h3>
                        <p>We pre-screen educators before inviting them to use your premises to conduct their programs.</p>
                    </div>
                    <div className="whyuseusGrid">
                        <img src="https://spaceboat.in/static/img/spacepartner/SP_InControl.png"  alt=":-)"/>
                        ...
                        <img src="https://spaceboat.in/static/img/spacepartner/SP_PriceRecommendation.png"  alt=":-)"/>
                        ...
                        <img src="https://spaceboat.in/static/img/spacepartner/SP_OngoingOperationalSupport.png"  alt=":-)"/>
